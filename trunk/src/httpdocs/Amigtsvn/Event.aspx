<%@ Page Title="" Language="C#" MasterPageFile="~/Amigtsvn/Admin.master" AutoEventWireup="true" CodeFile="Event.aspx.cs" Inherits="Amigtsvn_Event" %>
...
<div id="box">
    ...
    <asp:GridView ID="gridMain" runat="server" AutoGenerateColumns="False" 
        ...
        GridLines="None" DataKeyNames="EventId" onrowcommand="gridMain_RowCommand" 
        AllowPaging="True" onpageindexchanging="gridMain_PageIndexChanging">
        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
        <Columns>
            <asp:BoundField HeaderText="Tên sự kiện" DataField="EventNm" >
            <ItemStyle Width="200px" />
            </asp:BoundField>
            <asp:TemplateField HeaderText="Ngày bắt đầu">
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("FromDate","{0:dd/MM/yyyy}") %>'></asp:Label>
                </ItemTemplate>
                <ItemStyle Width="80px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Ngày kết thúc">
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("ToDate","{0:dd/MM/yyyy}") %>'></asp:Label>
                </ItemTemplate>
                <ItemStyle Width="80px" />
            </asp:TemplateField>
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Edit" CommandArgument= '<%# Eval("EventId") %>' >
