<%@ Page Title="" Language="C#" MasterPageFile="~/Amigtsvn/Admin.master" AutoEventWireup="true" CodeFile="SceneryEdit.aspx.cs" Inherits="Amigtsvn_SceneryEdit" %>
...
<ContentTemplate>
    <div id="box">
    <h3 id="adduser">Sửa địa điểm du lịch <asp:Label ID="txtUN" runat="server" Text="" ForeColor="#3399FF"></asp:Label></h3>
