<%@ Page Title="" Language="C#" MasterPageFile="~/Amigtsvn/Admin.master" AutoEventWireup="true" CodeFile="Scenery.aspx.cs" Inherits="Amigtsvn_Scenery" %>
...
<ul>
    ...
    <li class="current"><a href="Scenery.aspx">Địa điểm du lịch</a></li>
...
<ContentTemplate>
<div id="box">
    <h3>Danh sách địa điểm du lịch</h3>
    <br />
    &nbsp; Chọn vị trí : 
    ...
    <asp:GridView ID="gridMain" runat="server" AutoGenerateColumns="False" 
        ...
        GridLines="None" DataKeyNames="ScenId" onrowcommand="gridMain_RowCommand" 
        ...
        <Columns>
            <asp:TemplateField HeaderText="Hình đại diện">
                <ItemTemplate>
                    <asp:Image ID="imgPic" ImageUrl='<%# Eval("PicPath1", "../Images/site/Scenery/{0}") %>' ToolTip='<%# Eval("ScenNm") %>' runat="server" Height="71" Width="91" />
                </ItemTemplate>
                <ItemStyle Width="95px" />
            </asp:TemplateField>
            <asp:BoundField HeaderText="Tên địa điểm" DataField="ScenNm" >
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Edit" CommandArgument= '<%# Eval("ScenId") %>' >
                        <asp:Image ID="imgEdit" ImageUrl="~/Amigtsvn/img/icons/page_white_edit.png" ToolTip="Sửa, Phân quyền" runat="server" />
                    </asp:LinkButton>
                    <asp:LinkButton ID="LinkButton3" runat="server" CommandName="Picture" CommandArgument= '<%# Eval("ScenId") %>' >
                        <asp:Image ID="Image1" ImageUrl="~/Amigtsvn/img/icons/picture_mng.png" ToolTip="Quản lý ảnh" runat="server" />
                    </asp:LinkButton>
                    <asp:LinkButton ID="LinkButton2" runat="server" CommandName="SetStatus" CommandArgument= '<%# Eval("ScenId") %>'>
    ...
    <br />
    <div id="box">
    <h3 id="adduser">Thêm địa điểm du lịch</h3>
