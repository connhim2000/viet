        ...
        <td>
            <table class="tbl_tour_list">
                <asp:Repeater ID="RepTourKind" runat="server">
                    <ItemTemplate>
                        <tr class='<%# Eval("TourKindId").ToString() == Request.QueryString["TourKindId"] ? "tbl_tour_list_selected" : ""%>' style="cursor: pointer" onclick="DoClick('<%# "TourTronGoi.aspx?TourKindId=" + Eval("TourKindId")%>');">
                            <td>
